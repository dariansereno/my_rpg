...
{
    sfTexture *arw_r_tex = \
    sfTexture_createFromFile("contents/ui/buttons/arw_right.png", NULL);
    sfTexture *arw_l_tex = \
    sfTexture_createFromFile("contents/ui/buttons/arw_left.png", NULL);
...
st_menu *generate_menu(void)
{
    ...
    menu->items[0] = generate_object((sfVector2f){1247, 37}, \
    (sfIntRect){0, 0, 59, 67}, "contents/ui/menu/cross.png");
    menu->items[1] = generate_object((sfVector2f){888, 863}, \
    (sfIntRect){0, 0, 135, 103}, "contents/ui/menu/settings.png");
    menu->items[2] = generate_object((sfVector2f){751, 695}, \
    (sfIntRect){0, 0, 398, 150}, "contents/ui/menu/start_btn.png");
    menu->items[3] = generate_object((sfVector2f){721, 131}, \
    (sfIntRect){0, 0, 467, 177}, "contents/ui/menu/spaceciv.png");
    menu->view = sfView_createFromRect((sfFloatRect){610, 0, 700, HEIGHT});
